...
server.start(options, ({ port, endpoint, playground }) =>
  console.log(
    `
✅  GraphQL Server is running on localhost:${port}
⚛️  GraphQL Endpoint running on localhost:${port}${endpoint}
🎡  GraphQL Playground running on localhost:${port}${playground}
    `
  )
);
